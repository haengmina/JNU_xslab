...
static bool use_db9_comm = false;
...
int main()
{
	...
	else
	{
		...
		Protocol::Interface::Setting_Buffer setting = {};
		setting.type = Protocol::Interface::TYPE::RS485;
		setting.channel = Protocol::Interface::CHANNEL::CH1;
		setting.baudrate = 19200;
		setting.databit = Protocol::Interface::DATABIT::BIT8;
		setting.parity = Protocol::Interface::PARITY::NONE;
