...
if(CPPCHECK_PATH)
    set(CMAKE_C_CPPCHECK ${CPPCHECK_PATH} "--quiet" "--error-exitcode=1" "--enable=performance" "--enable=portability"
        "--suppress=normalCheckLevelMaxBranches" "--suppress=comparePointers" "--suppress=subtractPointers" "--suppress=syntaxError"
        "--suppress=unknownMacro" "--suppress=preprocessorErrorDirective" ${CPPCHECK_EXTRA_OPTION}
    )
    set(CMAKE_CXX_CPPCHECK ${CMAKE_C_CPPCHECK})
    message(STATUS "[ Enabled Static C/C++ Code Analysis Using cppcheck ]")
else()
    message(WARNING "[ cppcheck Tool NOT Found, Disabled Static C/C++ Code Analysis ]")
endif()
