...
add_link_options(-u _printf_float -Xlinker --gc-sections)
...
message("Must be DEFINE -mmcu -DF_CPU
example:
    set(CPU_OPTION -mmcu=atmega328p -DF_CPU=16000000UL)
